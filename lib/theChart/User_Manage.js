            ...
            if(storage.fun[i].pId==id){
                if(storage.fun[i].isChild){
                    ...
                    if(storage.fun[i].isSelect){
                        var label=$('<label style="color: #0088EB"><input type="checkbox" checked id="'+ storage.fun[i].id +'" isChild="'+ storage.fun[i].isChild +'" isSelect="'+ storage.fun[i].isSelect +'" name="'+ storage.fun[i].name +'" pId="'+ storage.fun[i].pId +'">'+ storage.fun[i].name +'</label>')
                        li.append(label)
                    }else{
                        var label=$('<label style="color: #0088EB"><input type="checkbox" id="'+ storage.fun[i].id +'" isChild="'+ storage.fun[i].isChild +'" isSelect="'+ storage.fun[i].isSelect +'" name="'+ storage.fun[i].name +'" pId="'+ storage.fun[i].pId +'">'+ storage.fun[i].name +'</label>')
                        li.append(label)
                    }
                    ...
                    if(storage.fun[i].isSelect){
                        var li=$('<li><label><input type="checkbox" checked id="'+ storage.fun[i].id +'" isChild="'+ storage.fun[i].isChild +'" isSelect="'+ storage.fun[i].isSelect +'" name="'+ storage.fun[i].name +'" pId="'+ storage.fun[i].pId +'">'+ storage.fun[i].name +'</label></li>')
                    }else{
                        var li=$('<li><label><input type="checkbox" id="'+ storage.fun[i].id +'" isChild="'+ storage.fun[i].isChild +'" isSelect="'+ storage.fun[i].isSelect +'" name="'+ storage.fun[i].name +'" pId="'+ storage.fun[i].pId +'">'+ storage.fun[i].name +'</label></li>')
                    }
                }
            }
            ul.append(li);
