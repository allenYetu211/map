...
define('User_Manage', ['jquery','local', 'api'], function(jq, l, _API) {
    ...
    $('.serverListData').on('click', function() {
        ...
        if(storage.userFlag=='roleInput'){
            ...
            $('#userTableList>ul input').each(function(i,v){
                ...
                // obj['isChild']=v.getAttribute('isChild');
                if((v.getAttribute('isSelect'))==='true'){
                    obj['isSelect']=true;
                }else {
                    obj['isSelect']=false;
                }
                // obj['isSelect']=v.getAttribute('isSelect');
                // obj['name']=v.getAttribute('name');
                // obj['pId']=v.getAttribute('pId');
                console.log(typeof obj['isSelect'])
                arr.push(obj);
            })
    ...
    $('body').on('click','#userTableList>ul input',function(){
        ...
        var input=$('#userTableList>ul input');
