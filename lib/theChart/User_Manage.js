            ...
            if(storage.fun[i].pId==id){
                if(storage.fun[i].isChild){
                    ...
                    if(storage.fun[i].isSelect){
                        ...
                        var li=$('<li><label><input type="checkbox" id="'+ storage.fun[i].id +'" isChild="'+ storage.fun[i].isChild +'" isSelect="'+ storage.fun[i].isSelect +'" name="'+ storage.fun[i].name +'" pId="'+ storage.fun[i].pId +'"></label>'+ storage.fun[i].name +'</li>')
                    }
                }
            }
            ul.append(li);
