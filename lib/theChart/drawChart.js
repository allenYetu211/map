        ...
        init: function(_level = '0', _code = '330283103') {
            ...
            for (let i = 0; i < this._indicator.indicators.length; i++) {
                ...
                if ($(location).find('.mouseMove').hasClass('draw_' + this._indicator.indicators[i].indicatorID)) {
                    ...
                    $(location).append("<div class='information " + locationClass + "-parent'> <a target='_blank' href='" + this._indicator.indicators[i].theme['url'] + "'></a><div class='mouseMove " + locationClass + " draw_" + this._indicator.indicators[i].indicatorID + " '></div></div>");
                }
                ...
                api.getData('GetIndicatorData', {
                    ...
                    if (this._indicator.indicators[i].mapType === 'pie' || this._indicator.indicators[i].mapType === 'bar') {
                    this.callBackMapData.push(callBackMap(this.processData, this._indicator.indicators[i].mapType))
                            ...
                            for (let i = 0; i < raw['indicatorData'].length; i++) {
                                ...
                                _data.reduce(function(c, item, idx) {
                                    ...
                                    if (c.length > idx) {
                                        ...
                                        // console.log('_rawItem:',_rawItem)
                                        // console.log(_rawItem['data'][idx]['data'][0])
                                        c[idx] = {
                                ...
                                //       contain.push({name: raw['indicatorData'][i]['data'][k]['other'][j]['F_NAME'],
                                //                     stack: raw['indicatorData'][i]['stack'],
                                //                      type: 'bar',
                                //                     data: [raw['indicatorData'][i]['data'][k]['data'][0]['F_TYPE_1'], ]})
                                //     }
                                //   }
                                // }
                            }
