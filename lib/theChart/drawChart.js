...
var cblin = {
    ...
    var initTerms = {
        ...
        init: function(_level = '0', _code = '330283103', bench = false) {
            console.log('this1:', this.__level__)
            if (this.__level__ === _level) {
                return
            } 
            this.__level__ = _level
            console.log('this2:', this.__level__ === _level)
            console.log(this.__level__)
            var handleKeyValues = []
            var location = ''
            var locationClass = ''
            var chartType = ''
            for (let i = 0; i < cblin._indicator.indicators.length; i++) {
                ...
                // if (initTerms.processData.indicatorData)
                api.getData('GetIndicatorData', {
                    ...
                    // cblin._indicator.indicators[i].mapType === 'bar' || 
                    if ( cblin._indicator.indicators[i].mapType === 'pie') {
