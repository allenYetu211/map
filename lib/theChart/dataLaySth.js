define('dataLaySth', ['jquery', 'map', 'chartInformations', 'mapIntroduce'], function(jq, map, ch, mi) {
    ...
    $('.confirm').on('click', function() {
        ...
        $('._popupSelect').each(function() {
            _ob[$(this).data('reoptype')]
            $(this).data('reoptype')
                // var _ob = {}
                // switch ($(this).data('reoptype')) {
                //     case 'F_NAME':
                //         _ob.reportName = $(this).find('input').val()
                //         break;
                //     case 'F_CODE':
                //         _ob.reportCode = $(this).find('input').val()
                //         break;
                //     case 'F_PAGE_COUNT':
                //         _ob.pageCount = $(this).find('input').val()
                //         break;
                //     case 'FK_REPORT_TYPE':
                //         _ob.reportName = $(this).find('input').val()
                //         break;
