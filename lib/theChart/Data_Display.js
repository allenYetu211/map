define("chartInformations", ['map', "jquery", "userservice", "translatePopup", 'local', 'api', 'common'], function(map, j, us, c, l, _API, common) {
  ...
  // setTimeout(function() {
  //     common.map.on('zoomend', function(e) {
  //         storage.__mapZoom = e.target._zoom
  //         console.log(storage.__mapZoom)
  //     })
  // }, 2000)
  ...
  $('body').on('click', 'button._isMap', function() {
    ...
    sendRequest.GetIndicators('-1', userPermissions.surveyCode)
    us.Layers.delLayers();
  ...
  $('body').on('click', '.basemap', function() {
    ...
    if ($(this).hasClass('actives')) {
      ...
      $(this).addClass('actives')
        // map.Ly.addTileLayer(storage.mapURL, newData);
  ...
  var sendRequest = {
    ...
    GetSurveyLevel: function() {
      _API._G('DataShow.asmx/GetSurveyLevel', {}, function(translateData) {
        ...
        console.log('GetSurveyLevel', translateData)
      })
    },
    ...
    GetDataByCatalogID: function(_id, _t) {
      _API._G('DataShow.asmx/GetDataByCatalogID', {
        ...
        storage.menuListTrdata.datas.forEach(function(_val) {
          ...
          var _ct = '<ul><li class="js_ontp" data-tn="' + _val.tableName + '" data-tp="' + _val.tilePath + '">' + _val.name + '<div class="right-options"> ' + _span + '<span class="basemap" data-id ="' + _val.id + '" data-tp="' + _val.tilePath + '"><img src="images/chart/icon_mapsort@2x.png" alt=""></span> <span class=""><img src="images/chart/icon_mapfold@2x.png" alt=""></span></div></li></ul>'
      ...
      for (var i = 0; i < storage.chartData.length; i++) {
        ...
        switch (_t.indiatorInfo.type) {
          case 'Text':
            ...
            break;
          case 'SingleText':
            draw.singleText(_t, ".draw" + _t.indiatorInfo.id)
            break;
          case 'Table':
   ...
   */
  var draw = {
    singleText: function(_id, _name) {
      console.log('singleText:',_id, _name)
    },
  ...
  var drawOn = {
    ...
    mapDraw: function(o) {
      ...
      console.log('_rtMap(storage.mapCbData):', _rtMap(storage.mapCbData))
  ...
  var callFun = {
    _mapF: function(fn) {
      ...
      console.log(userPermissions.surveyCode, callLevel)
        // userPermissions.surveyLevel = _level
      sendRequest.DrawMap(userPermissions.surveyLevel, userPermissions.surveyCode)
    }
  }
