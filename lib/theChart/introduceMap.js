define("mapIntroduce", ['map', "jquery", "userservice", "chartInformations", "sqlBuilder", "queryBuilder"], function(m, j, us, ch, sq, qb) {
    ...
    $('body').on('click', 'button.introduceButton', function() {
        $('#left-sidebar, #right-sidebar').addClass('close')
    ...
    $('body').on('click', '._reportShow-p p', function(e) {
        ...
        setTimeout(function() {
            $('#sheetFile')[0].contentWindow.ins_sheetPanel('10538', '15')
    ...
    $('._close').on('click', function() {
        ...
        $('#controlPanel').hide()
        $('#left-sidebar, #right-sidebar').removeClass('close')
    })
    ...
    var embellish = {
        ...
        showFieldData: function() {
            ...
            console.log('stroage.serchResultData', stroage.serchResultData)
