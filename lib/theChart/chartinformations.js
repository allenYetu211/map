    ...
    var draw = {
        ...
        menuList: function() {
            storage.menuNewData.forEach(function(_vals) {
                ...
                var _ct = '<li class="js_ontp"><div class="js_ontp catalogParse ' + _ontpClass + '" data-tn="' + _vals.datas.tableName + '"  data-tp="' + _vals.datas.tilePath + '">' + _vals.level.name + '<div class="right-options"><span>--</span> <span class="_option"><span></div></div>'
                ...
                function recursion(_val) {
                    ...
                    _ct += '<ul><li class="js_ontp ' + _onChildClass + '" data-tn="' + _vals.tableName + '" data-tp="' + _val.tilePath + '">' + _val.name + '<div class="right-options"><span>--</span> <span class="_option"><span></div></li>'
