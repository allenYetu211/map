    ...
    var toDealWith = {
        ...
        tsData: function() {
            ...
            for (var i = 0; i < storage.chartData.length; i++) {
                ...
                $(location).append("<div class='information " + sizeType + "-parent'><button data-sizemap=" + _t.indiatorInfo.size_type + " data-name=" + _t.indiatorInfo.name + " data-type=" + _t.indiatorInfo.type + " data-index=" + _t.indiatorInfo.id + " class=" + is_map + "></button> <a target='_blank' href='" + _t.indiatorInfo.id + "'></a><div data-index= " + _t.indiatorInfo.id + " class='mouseMove " + sizeType + " draw_" + _t.indiatorInfo.id + " '></div></div>");
