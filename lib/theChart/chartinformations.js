define("chartInformations", ['map', "jquery", "userservice"], function(map, j, us) {
            ...
            for (var i = 0; i < storage.chartData.length; i++) {
                ...
                switch (_t.indiatorInfo.type) {
                    case 'Text':
                        ...
                        break;
                    case 'Table':
                        draw.table(_t.indiatorData, ".draw_" + _t.indiatorInfo.id)
                        break;
                    default:
    ...
    var draw = {
        ...
        table: function(_data, _pClass) {
            console.log('_data', _data)
            var ct = '<h4 class="table-titles">统计表</h4><table  align="center"><tr class="_column">'
                                ...
                                case 1:
                                    return {
                                        ...
                                        legend: {
                                            ...
                                            data: ['钢架结构', '框架结构', '砖混结构', '砖木结构', '石木结构', '土木结构', '木结构', '简易结构', '排架结构'],
