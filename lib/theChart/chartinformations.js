define("chartInformations", ['map', "jquery", "userservice", "translatePopup"], function(map, j, us, c) {
    ...
    var sendRequest = {
        UserLogin: function(req) {
            api.getData('UserLogin', {
                ...
                _cms._setCookie('surveyCode', translateData.surveyInfo.surveyCode)
                $('.formData').hide();
        ...
        GetCatalog: function() {
            api.getData('GetCatalog', {}, function(translateData) {
    ...
    return {
        ...
        us_code: storage.UserLogin_surveyCode
    }
})