 ...
 * 用户服务调度类
 */
define("userservice", ["jquery", "map", "staticchart", "somoselect", "statictable", "chartInformations"], function(j, m, sc, ss, st, char) {
    function a(o) {
        /*
    ...
    function dblclick(o) {
        ...
        setTimeout(function() {
            require(["chartInformations", "map"],
                function(cr) {
                    // o.level++
                    console.log('dr:', cr)

                    cr.Mp(o.level, o.code)
                });
        }, 500)
    }
