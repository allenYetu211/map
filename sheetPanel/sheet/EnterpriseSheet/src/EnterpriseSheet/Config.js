...
Ext.define('EnterpriseSheet.Config', {
    ...
    setupDir : function(dir){
        Ext.apply(this, {
            ...
            urls: {
            	'documentInfo': dir+'document/documentInfo',	
		...
		'listSheet': dir+'document/list?onlyTpl=true',
                ...
                'loadSheetInfo2': dir+'sheet/loadSheetInfo2',
                'loadSheetInfo3': dir+'sheet/loadSheetInfo3',
                'loadqyDicti': dir+'sheet/loadqyDicti',
                ...
                'loadSheet5': dir+'sheet/loadSheet5',
