...
function Sheet(divId, zoomSize, withRowColTitle, withComment) {
  ...
  Ext.onReady(function() {
    ...
    if (withRowColTitle == false) {
      ...
      _this._SHEET_API.setColNameVisible(_this._SHEET_API_HD, _this._SHEET_API_HD.sheet.sheetId, withRowColTitle);
      _this._SHEET_API.setRowNameVisible(_this._SHEET_API_HD, _this._SHEET_API_HD.sheet.sheetId, withRowColTitle);
    }
  });
...
Sheet.prototype.loadStyle = function(reportId, callback, fn) {
  ...
  $.ajax({
    ...
    success: function(response) {
      var _page = JSON.parse(response.firstChild.innerHTML).perPage
      ...
      _this._SHEET_API.setColNameVisible(_this._SHEET_API_HD, _this._SHEET_API_HD.sheet.sheetId, _this._withRowColTitle);
      _this._SHEET_API.setRowNameVisible(_this._SHEET_API_HD, _this._SHEET_API_HD.sheet.sheetId, _this._withRowColTitle);
      _this._clearVar = [];
      var success = true;
      try {
